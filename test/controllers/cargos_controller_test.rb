...
class CargosControllerTest < ActionController::TestCase
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post :create, cargo: { codcargo: @cargo.codcargo, nombrecargo: @cargo.nombrecargo, string: @cargo.string }
    end
  ...
  test "should update cargo" do
    patch :update, id: @cargo, cargo: { codcargo: @cargo.codcargo, nombrecargo: @cargo.nombrecargo, string: @cargo.string }
    assert_redirected_to cargo_path(assigns(:cargo))
  end
