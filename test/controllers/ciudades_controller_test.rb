...
class CiudadesControllerTest < ActionController::TestCase
  ...
  test "should create ciudade" do
    assert_difference('Ciudade.count') do
      post :create, ciudade: { codciud: @ciudade.codciud, nombreciud: @ciudade.nombreciud, string: @ciudade.string }
    end
  ...
  test "should update ciudade" do
    patch :update, id: @ciudade, ciudade: { codciud: @ciudade.codciud, nombreciud: @ciudade.nombreciud, string: @ciudade.string }
    assert_redirected_to ciudade_path(assigns(:ciudade))
  end
