...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { cargo: @empleado.cargo, ciudad: @empleado.ciudad, codigo: @empleado.codigo, detalle: @empleado.detalle, direccion: @empleado.direccion, email: @empleado.email, nombre: @empleado.nombre, telefono: @empleado.telefono }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { cargo: @empleado.cargo, ciudad: @empleado.ciudad, codigo: @empleado.codigo, detalle: @empleado.detalle, direccion: @empleado.direccion, email: @empleado.email, nombre: @empleado.nombre, telefono: @empleado.telefono }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
